...
cat numery.txt | grep -E "^[0-9]{9}(1|3|5|7|9){1}[0-9]{1}$"
...
cat numery.txt | grep -E "^[99]{2}[0-9]{7}(2|4|6|8|0){1}[0-9]{1}$"
...
grep -E '^[0-9a-zA-Z]{1,16}@[a-z]+\.[a-z]{2,}' adresy.txt
...
grep -E '^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[1-4][0-9]|25[0-9])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[1-4][0-9]|25[0-5])$' ip.txt	